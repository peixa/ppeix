    ...
    <div class="layui-content">
        <div class="layui-row">
            <div class="layui-card">
                ...
                <form class="layui-form layui-card-body" action="/modeledit/1" method="post" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="file" name="image"   placeholder="please enter" autocomplete="off" class="layui-input">
                      <img src="/{{ $info->image }}" alt="" width="120" height="120">
                    </div>
